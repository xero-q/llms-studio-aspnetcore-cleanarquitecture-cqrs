...
namespace Infrastructure.Database.Migrations
{
    ...
    [Migration("20250626163402_RemoveTodo")]
    partial class RemoveTodo
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domain.Prompts.Prompt", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                    ...
                    b.HasIndex("ThreadId")
                        .HasDatabaseName("ix_prompts_thread_id");

                    b.ToTable("prompts", "public");
                });
            ...
            modelBuilder.Entity("Domain.Prompts.Prompt", b =>
                {
                    b.HasOne("Domain.Threads.Thread", "Thread")
                        .WithMany("Prompts")
                        .HasForeignKey("ThreadId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_prompts_threads_thread_id");
